...
const AdminUserDetail = ({match,getAllTeam,getTeamUser, users: {users}, team: {team},userTeam: {userTeam}}) => {
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-lg-6">                                        
                                        <Card.Title><b>Identificador(Leg.):</b> 1234</Card.Title>
                                        <Card.Title><b>Apellido:</b> Paredes</Card.Title>
                                        <Card.Title><b>Nombre:</b> Armando Luciano</Card.Title>
                                        <Card.Title><b>CUIL:</b> 3698521677</Card.Title>
                                        <Card.Title><b>Nacimiento:</b> 20/20/2019</Card.Title>
                                        <Card.Title><b>Rol:</b> Integrante de Equipo</Card.Title>                                                                               
                                        
                                    </div>
                                    <div className="col-lg-6">
                                        <Card.Title><b>Dirección:</b> Lavia 200</Card.Title>
                                        <Card.Title><b>Provincia:</b> Chaco</Card.Title>
                                        <Card.Title><b>Localidad: </b> Resistencia</Card.Title>                                        <Card.Title><b>Teléfono:</b> {users[index].phone}</Card.Title>
                                        <Card.Title><b>Email:</b> armando.paredes@</Card.Title>
    ...
    return (
        ...
        <Fragment>
            ...
            <h4 className="my-2">Información Personal de Armando Luciano Paredes</h4>
                            ...
                            <Card.Body>
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <Card.Title><b>Dirección:</b> Lavia 200</Card.Title>
                                        <Card.Title><b>Provincia:</b> Chaco</Card.Title>
                                        <Card.Title><b>Localidad: </b> Resistencia</Card.Title>
                                        <Card.Title><b>Teléfono:</b> 3624083256</Card.Title>
                                        <Card.Title><b>Email:</b> armando.paredes@ejemlo.com</Card.Title>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body bodyTeam">
                                        ...
                                        <ul className="list-group">
                                            <li key='0' className='itemTeam list-group-item-action list-group-item'><b>No se encuentra asociado a ningún Equipo</b></li>                
                                        </ul>                                      
                                    </div>
                                </div>
                            </div>
