...
const AdminReportConnectionLayout = ({match, auth:{user}, getTaskByUser, userTask: {userTask}}) => {
...
export default connect(mapStateToProps, {getTaskByUser})(AdminReportConnectionLayout)