...
const FirstChangePassword = ({match,history,setAlert, changePass, auth:{user}}) => {
console.log(user)
          ...
          <div className="col-sm-7 col-md-7">
            <div class="card">                      
              <div class="card-header"> <h5><i className="fas fa-user"></i> Cambio de Contraseña</h5></div>
                ...
                <span>Hola <b>{user ? user.name :""}</b>, detectamos que iniciaste por primera vez. Nececitamos que cambies tus credenciales para mayor seguridad</span>
                </div>             
                  <div className="form-group">
...
export default connect(mapStateToProps, {setAlert, changePass})(FirstChangePassword);
